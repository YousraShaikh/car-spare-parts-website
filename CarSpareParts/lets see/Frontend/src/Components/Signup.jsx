...
const Signup = () => {
  ...
  return (
    <div className="flex flex-col min-h-screen bg-gray-300 text-white pt-20"> {/* Adjusted padding */}
      {/* Main Container */}
      <div className="flex justify-center items-center min-h-[75vh] px-4 sm:px-6">
        {/* Form and Image Container */}
        <div className="flex w-full max-w-4xl min-h-[75vh] bg-gray-800 shadow-lg overflow-hidden rounded-lg">
          ...
          >
            ...
            <div className="absolute top-0 left-0 w-full h-full flex justify-center items-center bg-black bg-opacity-60">
              <motion.h2
                className="text-3xl font-extrabold text-orange-500 text-center drop-shadow-lg"
          ...
          <div className="w-full sm:w-1/2 p-6 sm:p-8 bg-gray-700">
            <motion.div
            ...
            >
              <h2 className="text-1xl font-medium text-center text-orange-500 mb-4">Create Your Account</h2>
              ...
              <form onSubmit={submitHandler}>
                ...
                <div className="mb-3">
                  ...
                  <motion.input
                    ...
                    className="w-3/4 mt-2 px-2 py-1 border rounded-lg text-white focus:outline-none focus:ring-2 focus:ring-orange-500 bg-gray-600 text-sm" // Adjusted width
